...
//    using SRDSpellsjson;
//
//    var the5ESrdSpellsJson = The5ESrdSpellsJson.FromJson(jsonString);
...
namespace SRDSpellsjson
{
    ...
    public partial class The5ESrdSpellsJson
    {
        [JsonProperty("index")]
    ...
    public partial class The5ESrdSpellsJson
    {
        public static List<The5ESrdSpellsJson> FromJson(string json) => JsonConvert.DeserializeObject<List<The5ESrdSpellsJson>>(json, SRDSpellsjson.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<The5ESrdSpellsJson> self) => JsonConvert.SerializeObject(self, SRDSpellsjson.Converter.Settings);
    }
