...
//
//    var spellsTwo5E = SpellsTwo5E.FromJson(jsonString);

namespace SecondSpells5e
{
    using System;
    ...
    public partial class SpellsTwo5E
    {
        ...
        [JsonProperty("tags")]
        public List<Class> Tags { get; set; }
    ...
    public partial class SpellsTwo5E
    {
        public static List<SpellsTwo5E> FromJson(string json) => JsonConvert.DeserializeObject<List<SpellsTwo5E>>(json, SecondSpells5e.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<SpellsTwo5E> self) => JsonConvert.SerializeObject(self, SecondSpells5e.Converter.Settings);
    }
